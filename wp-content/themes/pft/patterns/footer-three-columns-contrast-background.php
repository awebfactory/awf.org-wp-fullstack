 ...
 * Slug: pft/footer-three-columns-contrast-background
 * Categories: footer
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'pft' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'pft' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'pft' ); ?></a></p>
<!-- /wp:paragraph -->
